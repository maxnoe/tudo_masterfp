...
Der Korrekturfaktor für die Messung in $y$-Richtung beträgt \input{build/correction_factor_up.tex} in \enquote{forward} und \input{build/correction_factor_down.tex} in
