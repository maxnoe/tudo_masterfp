...
In \autoref{fig:fit_energy} wird diese Funktiongegen $\frac{1}{T}$ aufgetragen. Die Steigung der Ausgleichsgeraden liefert die Aktivierungsenergie zu:
\begin{equation}
...
\begin{figure}
  \centering
  \includegraphics{activation_energy.pdf}
...
Im Maximum wird der hintere Klammerausdruck gleich null. Daraus folgt für $\tau_0$ in Abhängigkeit der maximalen Temperatur:

\begin{equation}
  \label{eq:tau}
  \tau_0 = \frac{k_B T^2}{W b} \exp(-\frac{W}{k_B T}
\end{equation}
